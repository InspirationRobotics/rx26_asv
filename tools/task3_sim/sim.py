        ...
        with self.lock:
            ...
            return _clean({
                ...
                "camera": {"fx": W.Camera.FX, "w": W.Camera.W_PX, "h": W.Camera.H_PX,
                           "face_w": W.FACE_W, "face_h": W.FACE_H,
                           "face_z": self.world.dock.face_z, "cam_z": W.Boat.CAM_Z,
                           "pitch_deg": self.sc.cam_pitch_deg,
                           "band_rows": self.sc.hull_band_rows,
                           "slots": W.WINDOW_SLOTS, "indicator_up": W.INDICATOR_UP},
