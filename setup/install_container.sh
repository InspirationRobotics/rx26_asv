...
echo "== [2/4] Compile RoboCommand protobuf (proto/ -> robotx_2026/api/mission/) =="
...
python3 -m grpc_tools.protoc -I proto \
    --python_out=robotx_2026/api/mission proto/robocommand.proto \
  || protoc -I proto --python_out=robotx_2026/api/mission proto/robocommand.proto

echo "== [3/4] colcon build (robotx_2026 at root + interfaces/) =="
...
python3 -c "import robotx_2026; print('robotx_2026 import ok')"
python3 -c "from interfaces.msg import Occupancy; print('interfaces msgs ok')"
ros2 pkg executables robotx_2026 || true
